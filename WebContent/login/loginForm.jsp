...
<script>
	function checkValue() { //onsubmit calls this function to check if there are values lacking. the default value of submit is true so you have to make a condition where it would be false
